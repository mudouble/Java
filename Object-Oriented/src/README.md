...
## Lambda表达式
### 通常用于处理集合、多线程编程、事件处理等场景
### 和forEach使用，函数接口，线程和并发编程，事件处理，Stream API

### \t 是在标题之间创建水平间距

## 序列化和反序列化
### 序列化和反序列化是一种将对象转换为字节流和将字节流还原为对象的过程。这是一种常用于数据持久化和数据传输的技术，
### 特别是在 Java 中，它被广泛应用于将对象存储到文件、数据库或通过网络传输对象。
